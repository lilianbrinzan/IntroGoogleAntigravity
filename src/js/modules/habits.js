...
const Habits = {
        ...
        if (filteredHabits.length === 0) {
            this.listElement.innerHTML = `
                <div class="empty-state">
                    ...
                    <p class="empty-state-text">Adăugați primul obicei</p>
                </div>
            `;
            return;
        }
                ...
                <div class="habit-item ${isCompleted ? 'completed' : ''}" data-id="${habit.id}">
                    ...
                    <div class="habit-info">
                        ...
                        <span class="habit-category">
                            ...
                            ${habit.type === 'daily' ? 'Zilnic' : 'Săptămânal'}
                        </span>
                    </div>
    ...
    handleSubmit(e) {
        ...
        if (!name) {
            Helpers.showToast('Introduceți numele obiceiului', 'error');
            return;
        }
        ...
        if (id) {
            ...
            Helpers.showToast('Obicei actualizat', 'success');
        } else {
            // Add new
            this.habits.push({
            ...
            Helpers.showToast('Obicei adăugat', 'success');
        }
     ...
     */
    deleteHabit(id) {
        if (confirm('Ștergeți acest obicei?')) {
            this.habits = this.habits.filter(h => h.id !== id);
            this.saveHabits();
            this.render();
            this.updateStats();
            Helpers.showToast('Obicei șters', 'success');
